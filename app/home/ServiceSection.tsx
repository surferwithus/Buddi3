        ...
        <section className="px-40 py-20 bg-secondary/30">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <ServiceCard className="border-2 hover:border-orange transition-all hover:shadow-xl">
                ...
                <ServiceCard className="border-2 hover:border-orange transition-all hover:shadow-xl">
                    <ServiceCardContent className="p-8">
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-black">보호소 정보</h3>
                        <p className="text-brown mb-6">
                            전국 동물보호센터의 위치, 연락처, 수용 현황 등의 정보를 제공합니다
                        </p>
                        <Button asChild variant="outline" className="w-full">
